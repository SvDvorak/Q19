...
namespace Assets.World.Teleport {
    public class Portal : MonoBehaviour {
        ...
        int _justGotTeleportedTo;
        private TweenerCore<int, int, NoOptions> _teleportThicknessSafety;
        ...
        void HandleTravellers () {
            ...
            for (int i = 0; i < trackedTravellers.Count; i++) {
                ...
                if (portalSide != portalSideOld) {
                    ...
                    linkedPortal.OnTravellerEnterPortal (traveller, portalPosition);
        ...
        // If player just got teleported to this portal though we want to ensure that they aren't seeing the portal effect
        ...
        void OnTravellerEnterPortal (PortalTraveller traveller, Vector3 position) {
            if (!trackedTravellers.Contains (traveller)) {
                traveller.EnterPortalThreshold ();
                traveller.previousOffsetFromPortal = position - transform.position;
